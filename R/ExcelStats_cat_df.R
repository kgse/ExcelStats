#' Calculate Descriptive Statistics for a Categorical Variable as a Data Frame
#'
#' This function calculates descriptive statistics for a categorical variable in a data frame and returns them as a data frame.
#'
